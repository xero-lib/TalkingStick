    ...
    if(hasRoles(interaction.member)) {
        if (
            ...
            if (interaction.member.voice.channel && !member.voice.channel) {
                ...
                interaction.reply({ content: `${member.voice.channel} is not in your voice channel.`, ephemeral: true }).catch(datedErr);
            }
            ...
            } /*todo*/ // else if (!interaction.member.voice.channel && !membervoice.channel) 
