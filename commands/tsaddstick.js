          ...
          if (
            ...
            message.mentions.members
              ...
              .then(() =>
                console.log(
                  date(),
                  `Successfully added the Stick Holder role to ${
                    message.mentions.members.first().username
                  }#${message.mentions.members.first().discriminator} (${
                    message.mentions.members.first().id
                  }) by ${message.member.user.username}#${
                    message.member.user.discriminator
                  } (${message.member.id}) in ${message.guild.name}`
                )
              )
              .catch((err) =>
                console.error(
                  date(),
                  `Could not add the Stick Holder role to ${
                    message.mentions.members.first().username
                  }#${message.mentions.members.first().discriminator} (${
                    message.mentions.members.first().id
                  }) by ${message.member.user.username}#${
            ...
            message.mentions.members
              ...
              .then(() =>
                console.log(
                  date(),
                  `Successfully unmuted ${message.mentions.members.first()}#${
                    message.mentions.members.first().discriminator
                  } (${message.mentions.members.first().id}) by ${
